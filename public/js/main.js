...
(function ($) {
  ...
  $offcanvasNav.on("click", "li a, li .menu-expand", function (e) {
    ...
    if ($this.parent().attr("class").match(/\b(menu-item-has-children|has-children|has-sub-menu)\b/) && ($this.attr("href") === "#" || $this.attr("href") === "" || $this.hasClass("menu-expand"))) {
      e.preventDefault();
  ...
  var $html = $("html");
  var $body = $("body");
  var $elementCarousel = $(".quicky-element-carousel"); // Check if element exists
  ...
  if ($elementCarousel.elExists()) {
    ...
    $elementCarousel.each(function (index, element) {
      var $this = $(this); // Carousel Options
      ...
      var $spaceBetween = $options.spaceBetween ? parseInt($options.spaceBetween, 10) : 0,
          ...
          $prevArrow = $arrows === true ? $options.prevArrow ? '<span class="' + $options.prevArrow.buttonClass + '"><i class="' + $options.prevArrow.iconClass + '"></i></span>' : '<button class="tty-slick-text-btn tty-slick-text-prev"><i class="icon-arrow-left"></i></span>' : "",
          $nextArrow = $arrows === true ? $options.nextArrow ? '<span class="' + $options.nextArrow.buttonClass + '"><i class="' + $options.nextArrow.iconClass + '"></i></span>' : '<button class="tty-slick-text-btn tty-slick-text-next"><i class="icon-arrow-right"></i></span>' : "",
